...
public class SendJMail {
	...
	String from = "18137393583@163.com"; 				// 邮件发送人的邮件地址
	String to = email; 										// 邮件接收人的邮件地址
	final String username = "18137393583@163.com";  	//发件人的邮件帐户
	final String password = "pcgf742751833";   					//发件人的邮件密码
	...
	props.setProperty("mail.smtp.auth", "true");//是否验证用户信息
	//创建Session对象,session对象表示整个邮件的环境信息
	Session session = Session.getInstance(props);//创建数据库通信的连接
	//设置输出调试信息
